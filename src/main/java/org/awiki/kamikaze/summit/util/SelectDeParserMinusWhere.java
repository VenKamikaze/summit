...
/*
 * Note: Copy and paste of SelectDeParser with WHERE clause removed.
 * 
 * #%L
 * JSQLParser library
 * %%
 ...
 */
public class SelectDeParserMinusWhere implements SelectVisitor, SelectItemVisitor, FromItemVisitor, PivotVisitor {

    private StringBuilder buffer = new StringBuilder();
    private ExpressionVisitor expressionVisitor = new ExpressionVisitorAdapter();

    public SelectDeParserMinusWhere() {
    }
     ...
     */
    public SelectDeParserMinusWhere(ExpressionVisitor expressionVisitor, StringBuilder buffer) {
        this.buffer = buffer;
