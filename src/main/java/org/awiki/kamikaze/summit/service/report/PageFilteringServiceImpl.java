...
public class PageFilteringServiceImpl implements PageFilteringService
{
  ...
  @Override
  public SourceProcessorResultTable filterPage(long applicationId, long pageId, final String filterType, final String searchText, long page, long rowsPerPage, boolean getTotalCount, final MultiValueMap<String, String> parameterMap)
  {
  ...
  public SourceProcessorResultTable filterPageByColumn(long applicationId, long pageId, final String filterType, final String columnName,
          final String searchText, long page, long rowsPerPage, boolean getTotalCount, final MultiValueMap<String, String> parameterMap)
  {
    final PageDto pageDto = pageMapper.map(appPageStore.findByApplicationIdAndPageId(applicationId, pageId).getPage());
  ...
  @Override
  public SourceProcessorResultTable filterRegion(long regionId, final String filterType, final String searchText, long page, long rowsPerPage, boolean getTotalCount, final MultiValueMap<String, String> parameterMap)
  {
  ...
  @Override
  public SourceProcessorResultTable filterRegionByColumn(long regionId, final String filterType, final String columnName, final String searchText, long page, long rowsPerPage, boolean getTotalCount, final MultiValueMap<String, String> parameterMap)
  {
    RegionDto region = mapper.map(regionStore.findOne(regionId), RegionDto.class);
   ...
   */
  private SourceProcessorResultTable filterQueryOnRegion(final RegionDto regionDto, final String filterType, final String columnName, final String searchText, long page, long rowsPerPage, boolean getTotalCount, final MultiValueMap<String, String> parameterMap) {
