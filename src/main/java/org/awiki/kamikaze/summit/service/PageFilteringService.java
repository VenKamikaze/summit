...
public interface PageFilteringService {
  ...
  /* With pagination */
  public SourceProcessorResultTable filterRegion(long regionId, final String searchText, long page, long rowsPerPage, boolean getTotalCount);
  public SourceProcessorResultTable filterRegionByColumn(long regionId, final String columnName, final String searchText, long page, long rowsPerPage, boolean getTotalCount);
