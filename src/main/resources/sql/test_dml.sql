...
insert into code_source_type values ('dml_report', 'text/plain; sql; dml; report', 1, 'text/plain; sql; dml; report');

-- TODO review this, seems odd being the same code as source_type
--insert into code_processing_type values ('dml_report', 'text/plain; sql; dml; report', 1, 'dml_report');

insert into code_region_type values ('Report', 'Report Region', 1, 'text/plain; sql; dml; report');

insert into code_region_position values ('body1', 'Top most region on template body', 3);

insert into region  (select nexval(region_seq), 'Test Report Region', 'body1', 'Report', 'text/plain; sql; dml; report');
