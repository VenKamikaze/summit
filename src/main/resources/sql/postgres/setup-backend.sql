...
insert into template select -61, null, 'Input Item - Text', 'org.awiki.kamikaze.summit.dto.render.FieldDto', '<input type="text" name="##__NAME__##" id="##__ID__##" value="##__DATA__##" />';
insert into template select -62, null, 'Input Item - Number', 'org.awiki.kamikaze.summit.dto.render.FieldDto', '<input type="number" name="##__NAME__##" id="##__ID__##" value="##__DATA__##" />'; -- HTML5 and IE10+ only.
