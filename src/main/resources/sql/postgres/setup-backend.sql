...
insert into template select -80, null, 'Input Item - Submit', 'org.awiki.kamikaze.summit.dto.render.FieldDto', '<div class="field"><input type="submit" name="##__NAME__##" id="##__ID__##" value="##__DATA__##" /></div>';
